...
static class GameMaster
{
    ...
    {
        string verb = travelMethod == TravelMethod.Horseback ? "on" : "by";
        return $"You're traveling to your destination {verb} {travelMethod.ToString().ToLower()}.";
    }
    ...
    {
        return $"{GameMaster.Describe(character: character, destination: destination, travelMethod: TravelMethod.Walking)}";
    }
}
